...
# Параметр firstName состоит из 1 символов (меньше допустимого)
def test_create_user_1_letter_in_first_name_get_unsucess_response():
    negative_assert("А")


# Тест 4. Неуспешное создание пользователя
# Параметр firstName состоит из 1 символов (больше допустимого)
